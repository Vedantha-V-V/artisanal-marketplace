...
function Footer() {
  return (
    <footer className="footer">
      <p>&copy; {new Date().getFullYear()} Art To Cart.</p>
      <p>Empowering Artisans with Every Sale</p>
      <a href="https://github.com/Vedantha-V-V/artisanal-marketplace" target='_blank' rel='noreferrer'>
        <button class="button">
